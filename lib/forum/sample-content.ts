...
const topicDetails: Record<
  string,
  { excerpt: string; body: string[]; commercial?: boolean }
> = {
  'legal-content-policy': {
    excerpt:
      'Какие темы разрешены на платформе и где проходит граница между практическим опытом и опасной схемой.',
    body: [
  ...
  'go-connection-leak': {
    excerpt:
      'Как нашли деградацию пула, локализовали причину и добавили защитные метрики.',
    body: [
  ...
  'project-estimation': {
    excerpt:
      'Практический шаблон оценки сроков, рисков и границ проекта до подписания договора.',
    body: [
  ...
  'affiliate-checklist': {
    excerpt:
      'Документы, правила трафика, атрибуция, выплаты и поддержка — что проверить до первой рекомендации.',
    commercial: true,
    body: [
  ...
  'manual-quality-standard': {
    excerpt:
      'Минимальные требования к пошаговым инструкциям: версия, входные условия, проверка результата и история изменений.',
    body: [
  ...
  return [
    {
      ...
      excerpt:
        primaryDetails?.excerpt ||
        `Практическое обсуждение участников раздела «${forum.title}».`,
    ...
    },
    {
      ...
      excerpt:
        'Общая тема для небольших вопросов, которым пока не требуется отдельное обсуждение.',
      author: 'Сообщество',
    ...
    },
    {
      ...
      excerpt:
        'Поддерживаемая участниками подборка документации, сервисов и открытых проектов.',
      author: 'Редакция',
      authorRole: 'Куратор',
      replies: 19,
      views: 874,
    ...
    },
    {
      ...
      excerpt:
        'Разбор решений, ограничений, ошибок и результатов без рекламных обещаний.',
      author: 'Виктория Н.',
      authorRole: 'Автор',
      replies: 27,
      views: 633,
    ...
    for (const forum of section.forums) {
      ...
      const posts: TopicPost[] = [
        ...
        },
        {
          ...
          body: [
            'Полезно дополнить исходные условия: размер команды, ограничения по бюджету и критерий, по которому решение признали успешным. Тогда кейс будет проще воспроизвести.',
          ],
          reactions: 7,
        },
        {
          ...
          body: [
            'Поддерживаю. Ещё стоит вынести итоговый чек-лист в базу знаний и связать его с этой темой — обсуждение сохранится, а инструкция получит версии.',
          ],
          reactions: 4,
        },
      ];
